...
QUnit.module("changeLogHelper", {});

let generalUpdates: ChangeLog.Update[] = [{
	version: "3.3.1",
	date: "06/13/2016",
	changes: [{
		title: "3.3.1:title",
...
test("For the case where there is only one update, getUpdatesSinceVersion returns that update if the version parameter is older", () => {
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version("2.3.0")), generalUpdates);
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version("3.2.0")), generalUpdates);
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version("3.3.0")), generalUpdates);
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version("3.2.99")), generalUpdates);
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version("0.0.0")), generalUpdates);
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version("2.99.99")), generalUpdates);
});
...
test("For the case where there is only one update. getUpdatesSinceVersion returns an empty list if the version parameter is newer", () => {
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version("3.3.2")), []);
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version("99.99.99")), []);
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version("3.99.0")), []);
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version("3.4.0")), []);
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version("4.0.0")), []);
});
...
test("For the case where there is only one update, getUpdatesSinceVersion returns the update if passed an undefined version", () => {
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, undefined), generalUpdates);
});
...
test("For the case where there is only one update, getUpdatesSinceVersion returns an empty list if the version parameter is the same", () => {
	deepEqual(ChangeLogHelper.getUpdatesSinceVersion(generalUpdates, new Version(generalUpdates[0].version)), []);
});
...
test("For the case where there is only one update, getUpdatesBetweenVersions returns the update if it is between the lower (exclusive) and upper (inclusive) versions", () => {
	deepEqual(ChangeLogHelper.getUpdatesBetweenVersions(generalUpdates, new Version("3.3.0"), new Version("3.3.2")), generalUpdates);
	deepEqual(ChangeLogHelper.getUpdatesBetweenVersions(generalUpdates, new Version("3.3.0"), new Version("3.3.1")), generalUpdates);
});
...
test("For the case where there is only one update, getUpdatesBetweenVersions returns an empty list if the lower version parameter is the same", () => {
	deepEqual(ChangeLogHelper.getUpdatesBetweenVersions(generalUpdates, new Version("3.3.1"), new Version("3.3.2")), []);
	deepEqual(ChangeLogHelper.getUpdatesBetweenVersions(generalUpdates, new Version("3.3.1"), new Version("3.3.1")), []);
});
...
test("For the case where there is only one update, getUpdatesBetweenVersions behaves like there is no lower bound if it is undefined", () => {
	deepEqual(ChangeLogHelper.getUpdatesBetweenVersions(generalUpdates, undefined, new Version("3.3.2")), generalUpdates);
	deepEqual(ChangeLogHelper.getUpdatesBetweenVersions(generalUpdates, undefined, new Version("3.3.1")), generalUpdates);
	deepEqual(ChangeLogHelper.getUpdatesBetweenVersions(generalUpdates, undefined, new Version("3.3.0")), []);
});
