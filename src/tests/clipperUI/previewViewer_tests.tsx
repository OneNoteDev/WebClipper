...
export class PreviewViewerTests extends TestModule {
	...
	protected tests() {
		...
		let serifFontFamily = this.stringsJson["WebClipper.FontFamily.Preview.SerifDefault"];
...
(new PreviewViewerTests()).runTests();
