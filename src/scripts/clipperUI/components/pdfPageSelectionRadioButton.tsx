...
class PdfPageSelectionRadioButton extends ComponentBase<{}, ClipperStateProp> {
	...
	getRadioButtons(): RadioButtonGroup {
		...
		return {
			...
			isAriaSet: true,
			innerElements: [
				<div role="radio" id={Constants.Ids.radioAllPagesLabel} className="pdf-control" {...this.enableInvoke({callback: this.onSelectionChange, tabIndex: pdfPreviewInfo.allPages ? selectedTabIndex : unselectedTabIndex, args: true, verticalArrowKeyNavSet: Constants.AriaSet.pdfPageSelection})}>
				...
				<div id={Constants.Ids.radioPageRangeLabel} className="pdf-control" {...this.enableInvoke({callback: this.onSelectionChange, tabIndex: !pdfPreviewInfo.allPages ? selectedTabIndex : unselectedTabIndex, args: false, verticalArrowKeyNavSet: Constants.AriaSet.pdfPageSelection})}>
					<div className={"pdf-indicator pdf-radio-indicator"}>
