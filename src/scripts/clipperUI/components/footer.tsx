			...
			<div id={Constants.Ids.clipperFooterContainer} className="footerFont"
				...
				<div>
					<div className="footerButtonsLeft confineText">
						<a id={Constants.Ids.feedbackButton} {...this.enableInvoke({handleMethod: this.handleFeedbackButton, tabIndex: 80}) }>
					...
					{showUserInfo
						? (<div className="footerButtonsRight">
							<a id={Constants.Ids.currentUserControl} {...this.enableInvoke({handleMethod: this.userControlHandler, tabIndex: 81})} aria-expanded={this.state.userSettingsOpened}>
					...
					? (<div id={Constants.Ids.userSettingsContainer} className="userSettingsFont"
							...
							<div className="userDetails confineText">
								...
								<a id={Constants.Ids.signOutButton} className="userActionButton"
									{...this.enableInvoke({handleMethod: this.handleSignOutButton, tabIndex: 82})}>
