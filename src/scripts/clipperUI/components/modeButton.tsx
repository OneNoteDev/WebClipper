	...
	public render() {
		...
		return (
			<a className={className} role="option" aria-selected={this.props.selected}
				...
				{...this.enableInvoke({callback: this.buttonHandler, tabIndex: this.props.tabIndex, ariaNavigationSet: {name: Constants.AriaSet.modeButtonSet, direction: Constants.AriaNavigation.vertical}})}>
