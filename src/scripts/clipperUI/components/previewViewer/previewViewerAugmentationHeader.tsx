...
class PreviewViewerAugmentationHeaderClass extends PreviewViewerHeaderComponentBase<{}, PreviewViewerAugmentationHeaderProp> {
	...
	private getHighlightGroup(): ControlGroup {
		...
		let classForHighlighter = highlighterEnabled ? PreviewViewerHeaderComponentBase.HeaderClasses.Button.active : "";
		...
		return {
			...
			innerElements: [
				<button
					...
					className={!this.props.serif ? PreviewViewerHeaderComponentBase.HeaderClasses.Button.activeControlButton : PreviewViewerHeaderComponentBase.HeaderClasses.Button.controlButton}
					type="button">
	...
	private getFontSizeGroup(): ControlGroup {
		return {
			...
			className: PreviewViewerHeaderComponentBase.HeaderClasses.Button.relatedButtons,
			innerElements: [
				<button className={PreviewViewerHeaderComponentBase.HeaderClasses.Button.controlButton}
