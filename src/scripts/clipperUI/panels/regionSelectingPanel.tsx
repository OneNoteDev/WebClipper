		...
		return (
			<div id={Constants.Ids.regionInstructionsContainer}>
				<div className="regionClipPadding">
					...
					<a id={Constants.Ids.regionClipCancelButton} {...this.enableInvoke(this.handleCancelButton, 70, undefined, undefined, undefined, Constants.DefaultAction.regionClipCancelButton)}>
