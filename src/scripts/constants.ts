export module Constants {
	...
	export module Settings {
		...
		export var maxClipSuccessForRatingsPrompt = 12; // maxClipSuccessForRatingsPrompt % gapBetweenClipSuccessForRatingsPrompt === 0 // TODO 10 (or something)
		...
		export var minClipSuccessForRatingsPrompt = 4; // minClipSuccessForRatingsPrompt % gapBetweenClipSuccessForRatingsPrompt === 0
