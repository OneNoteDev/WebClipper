...
var ComponentBase = (function () {
     ...
     */
    ComponentBase.prototype.enableInvoke = function (handleMethod, tabIndex, args, idOverride) {
        if (tabIndex === void 0) { tabIndex = 0; }
        if (idOverride === void 0) { idOverride = undefined; }
        // Because of the way mithril does the callbacks, we need to rescope it so that "this" points to the class
        if (handleMethod) {
        ...
        return {
            ...
            onkeyup: function (e) {
                var element = e.currentTarget;
                if (e.which === constants_1.Constants.KeyCodes.enter) {
...
var CloseButtonClass = (function (_super) {
    ...
    CloseButtonClass.prototype.render = function () {
        return ({tag: "div", attrs: {id:constants_1.Constants.Ids.closeButtonContainer}, children: [
				{tag: "a", attrs: Object.assign({id:constants_1.Constants.Ids.closeButton, "aria-label":localization_1.Localization.getLocalizedString("WebClipper.Action.CloseTheClipper")},  this.enableInvoke(this.props.onClickHandler, 300, this.props.onClickHandlerParams)), children: [
...
var DialogPanelClass = (function (_super) {
    ...
    DialogPanelClass.prototype.render = function () {
        ...
        return ({tag: "div", attrs: {id:containerId}, children: [
            ...
            return ({tag: "a", attrs: Object.assign({id:button.id, className:"dialogButton"},  _this.enableInvoke(button.handler, 70)), children: [
    ...
    TooltipRendererClass.prototype.getChangeLogPanel = function () {
        ...
        return ({tag: "div", attrs: {}, children: [
				...
				{tag: "div", attrs: {className:"wideButtonContainer changelog-button"}, children: [
					{tag: "a", attrs: Object.assign({id:constants_1.Constants.Ids.proceedToWebClipperButton},  this.enableInvoke(handleProceedToWebClipperButton, 10)), children: [
